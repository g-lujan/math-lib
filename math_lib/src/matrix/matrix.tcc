...
template <typename T, typename U, size_t TRows, size_t TCols>
Matrix<std::common_type_t<T, U>, TRows, TCols> operator+(const Matrix<T, TRows, TCols> &m1, const Matrix<U, TRows, TCols> &m2)
{
...
template <typename T, size_t TRows, size_t TCols>
Matrix<T, TCols, TRows> Matrix<T, TRows, TCols>::transpose()
{
